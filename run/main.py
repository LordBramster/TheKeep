...
class App(ttk.Frame):
    ...
    def setup_create_account(self):
        ...
        frame_root = ttk.Frame(new_window, padding=(0, 0, 0, 10))
        ...
        frame_account = ttk.Frame(frame_root, padding=(0, 0, 0, 0))
        ...
        frame_pass = ttk.Frame(frame_root, padding=(0, 0, 0, 0))
        ...
        frame_confirm = ttk.Frame(frame_root, padding=(0, 0, 0, 0))
        ...
        entry_pass_confirm.insert(0, self.var_enter_password.get())
    ...
    def setup_login(self):
        ...
        button = ttk.Button(frame_root, text="Sign In",
                            style="Accent.TButton",
                            command=lambda: self.setup_next_window('VIEW'))
